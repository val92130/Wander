<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="Wander.Administration.index" %>
...
<html lang="en" ng-app="adminApp">
   ...
   <body ng-controller="manager">
      <div class="hideOverlay" style="position: absolute; bottom: 0px; width: 100%; height: 100%; background-color: #2B2B2B; z-index: 1500"></div>
      <div id="wrapper">
         <!-- Navigation -->
         ...
         <div id="page-wrapper">
            <div class="row">
             ...
             <div id="content">
                 <%
                     Response.WriteFile("/includes/chat.html");
                     Response.WriteFile("/includes/overview.html");
                     Response.WriteFile("/includes/players.html");
                     Response.WriteFile("/includes/weather.html");
                     Response.WriteFile("/includes/users.html");
                 %>
             </div>
